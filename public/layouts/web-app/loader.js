    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: false,
                logo: {
                    darkLogo: '../src/assets/img/logo-5.svg',
                    lightLogo: '../src/assets/img/logo-5.svg'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/img/logotb.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
